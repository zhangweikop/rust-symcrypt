...
impl Triple {
    pub fn get_target_triple() -> Self {
        ...
        match (target_os.as_str(), target_arch.as_str()) {
            ...
            ("macos", "aarch64") => Triple::aarch64_apple_darwin,
            ("macos", "x86_64") => Triple::x86_64_apple_darwin,
    ...
    pub fn to_triple(&self) -> &'static str {
        match self {
            ...
            Triple::x86_64_apple_darwin => "x86_64-apple-darwin",
            Triple::aarch64_apple_darwin  => "aarch64-apple-darwin",
        }
    }
}
